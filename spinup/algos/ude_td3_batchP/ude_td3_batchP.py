...
from spinup.algos.ude_td3_batchP.core import get_vars
from spinup.algos.ude_td3_batchP.investigate_uncertainty import DropoutUncertaintyModule
...
"""
def ude_td3_batchP(env_fn, render_env=False, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0,
...
if __name__ == '__main__':
    ...
    # import pdb; pdb.set_trace()
    ude_td3_batchP(lambda: gym.make(args.env), render_env=args.render_env,
