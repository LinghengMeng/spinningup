...
import gym
import time
from spinup.algos.ddpg_origional import core
from spinup.algos.ddpg_origional.core import get_vars
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='ddpg_origional')
