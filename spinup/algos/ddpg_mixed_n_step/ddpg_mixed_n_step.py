...
import time
from spinup.algos.ddpg_mixed_n_step import core
from spinup.algos.ddpg_mixed_n_step.core import get_vars, MLP, MultiHeadMLP
...
class ReplayBuffer:
    ...
    def sample_batch_mixed_n_step(self, batch_size=32,
                                  n_step_start=1,
                                  n_step_end=1):
        """
        return training batch for n-step experiences
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='ddpg_mixed_n_step')
    ...
    ddpg_mixed_n_step(env_name=args.env, new_mlp=args.new_mlp, dropout_rate=args.dropout_rate,
