...
def ddpg(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0, 
    ...
    with tf.variable_scope('main'):
        ...
        actor = MLP(list(hidden_sizes)+[act_dim], output_activation=tf.keras.activations.tanh)
        critic = MLP(list(hidden_sizes) + [1], output_activation=tf.keras.activations.linear)
    ...
    with tf.variable_scope('target'):
        ...
        actor_targ = MLP(list(hidden_sizes)+[act_dim], output_activation=tf.keras.activations.tanh)
        critic_targ = MLP(list(hidden_sizes) + [1], output_activation=tf.keras.activations.linear)
